...
//===================================================================================
// You can add more timers here. I have three together in the same block and I divided my block by 3 to make each timer width 33.33%. I we added another, you could use 25% if you want them on the same line. See timer.css line 17.

initializeTimer("timer1", 60); // 1 minute
initializeTimer("timer2", 20); // 20 seconds
