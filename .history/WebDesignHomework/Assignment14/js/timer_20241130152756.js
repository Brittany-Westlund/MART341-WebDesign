...
function initializeTimer(timerId, timeLimit) {
  ...
  let timerInterval = null; // Stores interval ID
  let remainingPathColor = COLOR_CODES.info.color; // Tells what start color to start with, in this case info: "green" that we set above
